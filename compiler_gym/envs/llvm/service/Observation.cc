...
Status setObservation(LlvmObservationSpace space, const fs::path& workingDirectory,
  ...
  switch (space) {
    ...
    case LlvmObservationSpace::INST_COUNT: {
      ...
      *reply.mutable_int64_tensor()->mutable_values() = {features.begin(), features.end()};
      break;
    }
    ...
    case LlvmObservationSpace::PROGRAML_JSON: {
      ...
      Opaque opaque;
      opaque.set_format(space == LlvmObservationSpace::PROGRAML ? "json://networkx/MultiDiGraph" : "json://");
